      ...
      <div className="">
        ...
        <div className="">
          {proyects.map((e, l) => (
            ...
            //   className={`flex`}
            // >
            //   <div className="border projects__row-img-cont relative flex flex-col items-center justify-center">
            //     <img
            //       src={e.img}
            ...
            //     <h3 className="projects__row-content-title fondo-bold">{e.title}</h3>
